...
$sql = "SELECT galleryName, galleryHeader, themeType, firstColour, secondColour, fontColour FROM projects WHERE id=$ids";
...
<body>
    <div class="content">
                    ...
                    <div class="place">
                        <div class="form">
                            ...
                            <input type="text" name="fc" id="fc" placeholder="ENTER FIRST COLOUR" pattern="[a-fA-F\d]+"
                                required value="<?php echo $rows[2]; ?>">
                            ...
                            <input type="text" name="sc" id="sc" placeholder="ENTER SECOND COLOUR" pattern="[a-fA-F\d]+"
                                required value="<?php echo $rows[3]; ?>">
        ...
        <script src="../../scripts-js/drag_and_drop_for_edit.js"></script>
</body>
